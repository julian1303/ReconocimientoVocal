...
<body>
    ...
    <div id="CrearHuella" class="container"> <!-- crear huella vocal--> 
        ...
        <fieldset>
            <button id="CrearHuellaB"  type="button" onclick="loadLog()">Crear huella</button>        
        </fieldset>  
...
<div class="container"><!-- autenticar-->  
    <form id="myformA" action="index.php" method="post">
        ...
        <fieldset>
            ...
            <fieldset>
                <fieldset>
                    <button  id="red"  value="" type="button" onclick="Grabar2(this);" required data-submit="...Sending">Record</button>
                </fieldset> 
    ...
    function loadLog(){
            ...
            xhttp.onreadystatechange = function(){
                if (xhttp.readyState == 4 && xhttp.status ==200){
                    /*
                        ...
                        echo "swal({title: 'Correcto',text: 'Creacion de huella exitosa, frase detectada $r2 con una confidencialidad de $r3', type: 'success',confirmButtonText: 'Cool'});";
                        } else {
                        echo "swal({ title: 'Error!',  text: '$r hola',  type: 'error',  confirmButtonText: 'Cool'})";
                        }*/
        ...
        xhttp.send("email="+correo+"&password="+contraseña+"&mydata="+data+"");            
    }
</script>
